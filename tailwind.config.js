...
export default {
  ...
  theme: {
    extend: {
      colors: {
        // Primary palette (Luminous Glass design system)
        primary: {
          50: '#ecfeff',
          100: '#cffafe',
          200: '#a5f3fc',
      ...
      boxShadow: {
        'luminous': '0 10px 40px -26px rgba(56, 189, 248, 0.45)',
        'luminous-lg': '0 25px 80px -20px rgba(56, 189, 248, 0.55)',
        'luminous-sm': '0 5px 20px -10px rgba(56, 189, 248, 0.4)',
